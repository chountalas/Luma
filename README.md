...
Presets let you switch the overall display effect between Subtle, Balanced, Deep, and Custom. Subtle keeps changes lighter, Balanced uses the default daily setup, and Deep applies stronger nighttime warmth and dimming.
...
- `dist/Luma-0.1.2-arm64.dmg`
- `dist/Luma-0.1.2-arm64.zip`
- `dist/checksums.txt`
